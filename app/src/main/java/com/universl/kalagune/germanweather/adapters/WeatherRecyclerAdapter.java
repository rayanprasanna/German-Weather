package com.universl.kalagune.germanweather.adapters;
...
import com.universl.kalagune.germanweather.models.WeatherViewHolder;
...
public class WeatherRecyclerAdapter extends RecyclerView.Adapter<WeatherViewHolder> {
    ...
    public void onBindViewHolder(WeatherViewHolder customViewHolder, int i) {
        ...
        if (dateArray[0].equalsIgnoreCase("Mon")){
            customViewHolder.itemDate.setText("Montag" + " " + dateArray[1] + " " + dateArray[2] + " " + dateArray[3]);
        }else if (dateArray[0].equalsIgnoreCase("Tue")){
            customViewHolder.itemDate.setText("Dienstag" + " " + dateArray[1] + " " + dateArray[2] + " " + dateArray[3]);
        }else if (dateArray[0].equalsIgnoreCase("Wed")){
            customViewHolder.itemDate.setText("Mittwoch" + " " + dateArray[1] + " " + dateArray[2] + " " + dateArray[3]);
        }else if (dateArray[0].equalsIgnoreCase("Thu")){
            customViewHolder.itemDate.setText("Donnerstag" + " " + dateArray[1] + " " + dateArray[2] + " " + dateArray[3]);
        }else if (dateArray[0].equalsIgnoreCase("Fri")){
            customViewHolder.itemDate.setText("Freitag" + " " + dateArray[1] + " " + dateArray[2] + " " + dateArray[3]);
        }else if (dateArray[0].equalsIgnoreCase("Sat")){
            customViewHolder.itemDate.setText("Samstag" + " " + dateArray[1] + " " + dateArray[2] + " " + dateArray[3]);
        }else if (dateArray[0].equalsIgnoreCase("Sun")){
            customViewHolder.itemDate.setText("Sonntag" + " " + dateArray[1] + " " + dateArray[2] + " " + dateArray[3]);
        }
